...
# end make_image_cube
  ...
  - id: find_diagnostics
    ...
    run: calculate_image_diagnostics.cwl
    in:
      - id: flat_noise_image
        source: image/image_I_nonpb_name
      - id: flat_noise_rms_image
